...
var AtTabBar = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtTabBar, [{
    ...
    value: function _createData() {
      ...
      var loopArray4 = tabList.map(function (item, i) {
        var _classNames;
        ...
        var $compid__29 = (0, _index.genCompid)(__prefix + "JCwuPlbdbf" + i);
        item.$original.iconType && _index.propsManager.set({
          "dot": $loopState__temp8,
          "value": item.$original.text,
          "maxValue": item.$original.max
        }, $compid__29);
        var $compid__30 = (0, _index.genCompid)(__prefix + "VgUzScAFUA" + i);
        item.$original.image && _index.propsManager.set({
          "dot": $loopState__temp14,
          "value": item.$original.text,
          "maxValue": item.$original.max
        }, $compid__30);
        var $compid__31 = (0, _index.genCompid)(__prefix + "CjkGAMLnrQ" + i);
        _index.propsManager.set({
          "dot": item.$original.iconType || item.$original.image ? false : !!item.$original.dot,
          "value": item.$original.iconType || item.$original.image ? null : item.$original.text,
          "maxValue": item.$original.iconType || item.$original.image ? null : item.$original.max
        }, $compid__31);
        return {
  ...
  return AtTabBar;
}(_component2.default), _class.$$events = ["handleClick"], _class.$$componentPath = "Users/parker/front-end_development/taro/myApp/node_modules/taro-ui/dist/weapp/components/tab-bar/index", _temp2);
